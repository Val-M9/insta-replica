...
const Header = () => {
  ...
  return (
    <header className="h-16 bg-white border-b boreder-gray-primary mb-8">
      <div className="container mx-auto max-w-screen-lg h-full">
        <div className="text-gray-700 flex justify-between h-full">
          ...
          <div className="text-center flex items-center align-items">
            {user ? (
              <>
                ...
                <button type="button" title="Sign Out" onClick={signOut} onKeyDown={signOutOnEnter}>
                  <svg
                    className="w-8 mr-6 text-black-light cursor-pointer"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <>
                ...
                <Link to={ROUTES.SIGN_UP}>
                  <button type="button" className="font-bold text-sm text-blue-medium w-20 h-8">
                    Sign Up
                  </button>
                </Link>
              </>
